...
class HnSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        for content in contents:
            ...
            date = content.xpath('.//td[3]/font/text()').extract_first()[0]
            ...
            if "002001001" in response.url:
                ...
                content_type = "04"
            yield GovernmentSpiderItem(title=title,date=date, detail_url=detail_url,area_code="河南", content_type=content_type, publish_id= "410000", thing_id="88")
